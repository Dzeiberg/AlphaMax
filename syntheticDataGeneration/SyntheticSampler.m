classdef SyntheticSampler < Sampler & handle
   ...
   methods
       function obj = SyntheticSampler(paramFilePath,varargin)
           ...
           %
           % Optional Arguments:
           %    - setNumberStart : first parameter set to process if not
           %    starting from set 1
           %
           %    - setNumberEnd : last parameter set to process;
           %                     if not default specified, will process all
           %
           % Properties
